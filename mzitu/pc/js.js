...
!(function() {
  if ($("#like")[0]) {
    $("#like").before('<div style="padding:10px;margin-bottom:10px;font-size:0"><a target="_blank" style="display: block;" href="https://mmzztt.com/"><img alt="美之图" src="https://cdn.jsdelivr.net/gh/xmzt/static/mzitu/pc/img/bn.jpg" width="240" height="160"></a></div>')
    }
})();
