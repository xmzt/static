...
!(function() {
  if ($("#like")[0]) {
    $("#like").before('<div style="padding:10px;margin-bottom:10px;font-size:0"><a target="_blank" style="display: block;" href="https://mmzztt.com/"><img alt="美之图" src="https://wxt.sinaimg.cn/large/9d52c073ly1gnyorwle2pj20dc08kt9e.jpg" width="240" height="154"></a></div>')
    }
})();
