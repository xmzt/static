...
!(function() {
    ...
    //ncov2019 start
    if ($("#like")[0]) {
        $("#like").before('<div style="padding:10px;margin-bottom:10px;font-size:0"><a target="_blank" style="display: block;" href="https://www.360kuai.com/mob/subject/400?sign=360_6aa05217"><img alt="新型肺炎实时疫情追踪" src="https://tvax1.sinaimg.cn/mw690/9d52c073gy1gbi5s496wcj206o06odi0.jpg" width="240" height="240"></a></div>')
    }
    //ncov2019 end
    if ($(".widgets_top")[0]) {
