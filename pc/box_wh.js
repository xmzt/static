...
!(function() {
    var style = "<style>#siderbox{height:222px}.box .singleImage .feed__link{padding:0!important}.box .singleImage{background:#eee!important}#siderbox .singleImage{background:#fff!important}.box .singleImage__title{padding:10px 10px 0 10px!important;font-size:12px!important;font-family:Arial!important;font-weight:normal!important}.box .singleImage__desc,.box .img .adTag{display:none!important}<style>";
    $("head").prepend(style);
    //ncov2019 start
    if ($("#like")[0]) {
